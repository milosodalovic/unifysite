        ...
        <div class="container">
            ...
            <div class="menu-container">
                ...
                <div class="navbar-brand">
                    <a href="index.html">
                        <img class="default-logo" src="/unify/img/logo3-light.png" alt="Logo">
                        <img class="shrink-logo" src="/unify/img/logo3-dark.png" alt="Logo">
                    </a>
                </div>
                <!-- ENd Navbar Brand -->
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-submenu active">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="active"><a href="feature_header_v6_transparent.html">Header v6 Transparent</a></li>
